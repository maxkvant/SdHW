...
`InfoLayer` -- отбражение общей информации об игре: hp игрока, число ходов...

`ArtefactsLayer` -- отбражение артефактов игрока, выборанного артефакта.

`FieldLayer` -- отбражение части игрового поля рядом с игроком.
